            ...
            <textarea 
              ...
              className="w-full h-[106px] p-[13px_19px] bg-white border border-[#E0DAF3] rounded-lg font-roboto text-base resize-none"
                ...
                <button 
                  ...
                  className="w-full flex justify-center items-center py-[13px] px-4 gap-1 h-[50px] bg-gradient-to-r from-[#8A53DD] to-[#372B9F] shadow-[0px_1px_2px_rgba(135,80,255,0.05)] rounded-[10px] mt-4"
                >
